...
export default class DateRangePicker extends React.Component {
  ...
  handleInputChange(e) {
    ...
    if (moment(value, 'L', true).isValid()) {
      ...
      if(this.props.onDateChange) {
        this.props.onDateChange({value, name, error: true});
      }
    }
  }
  ...
  render() {
    ...
    return (
      <div className={`datepicker-container flex1-1 ${this.props.mainClass}`} onMouseDown={ this.handleContainerMouseDown } style={ {position: 'relative'} }>
        <input
          disabled={disabled}
